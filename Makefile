...
binary-releases/repocheck.tgz: prepack | binary-releases
	mv $(shell npm pack) binary-releases/repocheck.tgz
	$(MAKE) binary-releases/repocheck.tgz.sha256

binary-releases/repocheck-fix.tgz: prepack | binary-releases
	mv $(shell npm pack --workspace '@repocheck/fix') binary-releases/repocheck-fix.tgz
	$(MAKE) binary-releases/repocheck-fix.tgz.sha256

binary-releases/repocheck-protect.tgz: prepack | binary-releases
	mv $(shell npm pack --workspace '@repocheck/protect') binary-releases/repocheck-protect.tgz
	$(MAKE) binary-releases/repocheck-protect.tgz.sha256

binary-releases/repocheck-alpine: prepack | binary-releases
	$(PKG) -t node16-alpine-x64 -o binary-releases/repocheck-alpine
	$(MAKE) binary-releases/repocheck-alpine.sha256

binary-releases/repocheck-linux: prepack | binary-releases
	$(PKG) -t node16-linux-x64 -o binary-releases/repocheck-linux
	$(MAKE) binary-releases/repocheck-linux.sha256
...
binary-releases/repocheck-linux-arm64: prepack | binary-releases
	$(PKG) -t node16-linux-arm64 -o binary-releases/repocheck-linux-arm64 --no-bytecode
	$(MAKE) binary-releases/repocheck-linux-arm64.sha256

binary-releases/repocheck-macos: prepack | binary-releases
	$(PKG) -t node16-macos-x64 -o binary-releases/repocheck-macos
	$(MAKE) binary-releases/repocheck-macos.sha256

binary-releases/repocheck-win.exe: prepack | binary-releases
	$(PKG) -t node16-win-x64 -o binary-releases/repocheck-win-unsigned.exe
	./release-scripts/sign-windows-binary.sh
	rm binary-releases/repocheck-win-unsigned.exe
	$(MAKE) binary-releases/repocheck-win.exe.sha256

binary-releases/repocheck-for-docker-desktop-darwin-x64.tar.gz: prepack | binary-releases
	./docker-desktop/build.sh darwin x64
	$(MAKE) binary-releases/repocheck-for-docker-desktop-darwin-x64.tar.gz.sha256

binary-releases/repocheck-for-docker-desktop-darwin-arm64.tar.gz: prepack | binary-releases
	./docker-desktop/build.sh darwin arm64
	$(MAKE) binary-releases/repocheck-for-docker-desktop-darwin-arm64.tar.gz.sha256
